...
fn test_svg_output_starts_with_xml_declaration() {
    ...
    let svg = LoGen::generate_svg("Test", Preset::MonogramBadge, &opts).unwrap();
...
fn test_png_output_is_valid() {
    let opts = RenderOptions::default();
    let png = LoGen::generate_png("Test", Preset::MonogramBadge, &opts).unwrap();
...
fn test_png_different_sizes_different_output() {
    ...
    let png_small = LoGen::generate_png("Test", Preset::MonogramBadge, &opts_small).unwrap();
    let png_large = LoGen::generate_png("Test", Preset::MonogramBadge, &opts_large).unwrap();
